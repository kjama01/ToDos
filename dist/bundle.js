...
addTask(task){
    ...
    this.tasks.push(new _Task_js__WEBPACK_IMPORTED_MODULE_0__["default"](task, "No date", 0));
}
deleteTask(task){
...
const now = new Date();
const formattedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__.format)(now, 'dd/MM/yyyy');
...
class UI{
    ...
    static initProjectsAddButtons(){
        ...
        projectPopupSubmitBtn.addEventListener('click',()=>{
            ...
            tab.push(new _Project_js__WEBPACK_IMPORTED_MODULE_0__["default"](popupinput.value));
            UI.loadProjects();
            UI.closePopups();
            }
        })  
...
let Inbox = new _Project_js__WEBPACK_IMPORTED_MODULE_0__["default"]("Inbox");
let Default = new _Project_js__WEBPACK_IMPORTED_MODULE_0__["default"]("Default");
tab.push(Inbox);
tab.push(Default);
