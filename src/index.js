...
class UI{
    ...
    static loadProjects(){
        ...
        tab.forEach((element)=>{
            if (["Inbox", "Today", "thisWeek"].includes(element.name)) {return;}
        ...
        projectname.addEventListener('click',()=>{UI.getProject(element)});
    ...
    static deleteTask(projectName, e){
        if(projectName===Today || projectName===thisWeek){ //szukanie we wszystkich projektach gdzie znajduje sie ten task
...
static getProject(projectName){
 ...
 static loadTasks(projectName){
    ...
    let tasklist = document.getElementById("tasklist");
        ...
        let projectNameInfo = (projectName.name==="Today" || projectName.name==="thisWeek") ?  `(${element.projectName})` : "";
